...
module.exports = function analyseManifest(manifest, options) {
  ...
  ret.pluginsToBeInstalled = pluginsForPermissions.toInstall.concat(pluginsForEngines.toInstall).concat(DEFAULT_PLUGINS);
  ret.pluginsToBeNotInstalled = pluginsForPermissions.toUninstall.concat(pluginsForEngines.toUninstall).concat(STALE_PLUGINS);
