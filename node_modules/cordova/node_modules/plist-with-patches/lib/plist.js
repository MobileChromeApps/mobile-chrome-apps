;(function (exports, DOMParser, xmlbuilder) {
	// Checks if running in a non-browser environment
 	var inNode = (typeof window === 'undefined' || typeof global === 'object') ? true : false
 	  , utf8_to_b64
 	  , b64_to_utf8;
		...
		if (node.nodeName === 'plist') {
			...
			for (i=0;i < node.childNodes.length;i++) {
				...
				if (!shouldIgnoreNode(node.childNodes[i])) {
					...
					if (res !== null && res !== undefined) new_arr.push( res );
				}
			}
			return new_arr;
		}
...
})(typeof exports === 'undefined' ? plist = {} : exports, (typeof window === 'undefined' || typeof global === 'object') ? require('xmldom').DOMParser : null, (typeof window === 'undefined' || typeof global === 'object') ? require('xmlbuilder') : xmlbuilder)
